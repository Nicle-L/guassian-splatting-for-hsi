...
import setproctitle
setproctitle.setproctitle("gsplat-cholesky-HSI2")
...
class SimpleTrainer2d:
    ...
    def __init__(
        ...
        # lr = 1e-3
        if model_name == "gaussianimage_cholesky_hsi_inter_color":
            from gaussianimage_cholesky_hsi_inter_color import GaussianImage_Cholesky
